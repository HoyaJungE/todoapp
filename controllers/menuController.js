...
async function getMenus(req, res) {
    try {
        const result = await db.execute(`
            SELECT MENU_NO, UPPR_MENU_NO, MENU_URL, MENU_NAME, CREATE_DT, ORDR, MENU_TYPE
            FROM MENU
...
async function addMenu(req, res) {
    ...
    const query = `
        INSERT INTO MENU (MENU_NO, UPPR_MENU_NO, MENU_URL, MENU_NAME, CREATE_DT, ORDR, MENU_TYPE)
        VALUES (MENU_NO_SEQ.NEXTVAL, :UPPR_MENU_NO, :MENU_URL, :MENU_NAME, SYSDATE, :ORDR, :MENU_TYPE)
    `;
